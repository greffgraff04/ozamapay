        ...
        >
          ...
          <div className="space-y-4 mb-12">
            <h1 className="text-5xl font-bold">
              Compliance <span className="bg-gradient-to-r from-[#FF7A00] to-[#FFAE66] bg-clip-text text-transparent">Center</span>
            </h1>
            <p className="text-white/50 text-lg">Regulatory Standards & Commitments</p>
          </div>
          ...
          >
            {complianceAreas.map((area, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-[#FF7A00]/50 transition-all"
                  whileHover={{ y: -5 }}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  viewport={{ once: true }}
                >
                  <Icon className="w-8 h-8 text-[#FF7A00] mb-4" />
          ...
          >
            ...
            <div className="space-y-3 text-white/70 mt-4">
          ...
          >
            ...
            <div className="space-y-2">
              <Link href="/aml-policy" className="text-[#FF7A00] hover:text-[#FF7A00] transition">
                → Anti-Money Laundering (AML) Policy
              </Link>
              <Link href="/kyc-policy" className="text-[#FF7A00] hover:text-[#FF7A00] transition block">
                → Know Your Customer (KYC) Policy
              </Link>
              <Link href="/privacy" className="text-[#FF7A00] hover:text-[#FF7A00] transition block">
                → Privacy Policy
              </Link>
              <Link href="/terms" className="text-[#FF7A00] hover:text-[#FF7A00] transition block">
                → Terms of Service
              </Link>
            </div>
          </motion.div>
