        ...
        >
          ...
          <div className="space-y-4 mb-12">
            <h1 className="text-5xl font-bold">
              Privacy <span className="bg-gradient-to-r from-[#FF7A00] to-[#FFAE66] bg-clip-text text-transparent">Policy</span>
            </h1>
            ...
            >
              ...
              <div className="space-y-4 ml-4">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-white/70 mt-3 ml-4">
                    <li>Email address</li>
